...
doppler secrets set APNS_KEY_ID=YOUR_KEY_ID --config prd
...
doppler secrets set APNS_KEY_PATH=/home/ubuntu/.config/bluesky-push-notifier/keys/AuthKey_YOUR_KEY_ID.p8 --config prd
doppler secrets set APNS_KEY_ID=YOUR_KEY_ID --config prd
doppler secrets set APNS_TEAM_ID=YOUR_TEAM_ID --config prd
doppler secrets set APNS_TOPIC=blue.catbird.app --config prd
doppler secrets set APNS_PRODUCTION=false --config prd
