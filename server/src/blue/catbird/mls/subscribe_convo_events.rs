...
//!Definitions for the `blue.catbird.mls.subscribeConvoEvents` namespace.
//!Firehose-style subscription for conversation updates (messages, reactions, typing indicators)
pub const NSID: &str = "blue.catbird.mls.subscribeConvoEvents";
...
///Firehose-style subscription stream
