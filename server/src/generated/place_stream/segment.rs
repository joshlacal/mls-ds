...
pub struct Segment<'a> {
    ...
    #[serde(borrow)]
    pub audio: std::option::Option<
        Vec<crate::generated::place_stream::segment::Audio<'a>>,
    >,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    ...
    pub video: std::option::Option<
        Vec<crate::generated::place_stream::segment::Video<'a>>,
    >,
}
...
pub struct Video<'a> {
    ...
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub framerate: std::option::Option<
        crate::generated::place_stream::segment::Framerate<'a>,
    >,
    pub height: i64,
    pub width: i64,
}
