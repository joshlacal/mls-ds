...
pub enum EventDetails<'a> {
    ...
    EmailUpdated(
        Box<
            crate::generated::tools_ozone::hosting::get_account_history::EmailUpdated<'a>,
        >,
    ),
    ...
    HandleUpdated(
        Box<
            crate::generated::tools_ozone::hosting::get_account_history::HandleUpdated<
                'a,
            >,
        >,
    ),
...
pub struct GetAccountHistoryOutput<'a> {
    ...
    #[serde(borrow)]
    pub events: Vec<
        crate::generated::tools_ozone::hosting::get_account_history::Event<'a>,
    >,
}
