...
pub struct LabelerPolicies<'a> {
    ...
    pub label_value_definitions: std::option::Option<
        Vec<crate::generated::com_atproto::label::LabelValueDefinition<'a>>,
    >,
...
impl<'a, S: labeler_policies_state::State> LabelerPoliciesBuilder<'a, S> {
    ...
    pub fn label_value_definitions(
        mut self,
        value: impl Into<
            Option<Vec<crate::generated::com_atproto::label::LabelValueDefinition<'a>>>,
        >,
    ) -> Self {
...
pub struct LabelerView<'a> {
    ...
    pub viewer: std::option::Option<
        crate::generated::app_bsky::labeler::LabelerViewerState<'a>,
    >,
}
...
impl<'a, S: labeler_view_state::State> LabelerViewBuilder<'a, S> {
    ...
    pub fn viewer(
        mut self,
        value: impl Into<
            Option<crate::generated::app_bsky::labeler::LabelerViewerState<'a>>,
        >,
    ) -> Self {
