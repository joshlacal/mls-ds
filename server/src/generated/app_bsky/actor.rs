...
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        ...
        defs: {
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("declaredAgePref"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: Some(
                        ::jacquard_common::CowStr::new_static(
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("liveEventPreferences"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: Some(
                        ::jacquard_common::CowStr::new_static(
            ...
            map.insert(
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    ...
                    properties: {
                        ...
                        map.insert(
                            ::jacquard_common::smol_str::SmolStr::new_static("germ"),
                            ::jacquard_lexicon::lexicon::LexObjectProperty::Ref(::jacquard_lexicon::lexicon::LexRef {
                                description: None,
                                r#ref: ::jacquard_common::CowStr::new_static(
...
pub struct BskyAppStatePref<'a> {
    ...
    pub active_progress_guide: std::option::Option<
        crate::generated::app_bsky::actor::BskyAppProgressGuide<'a>,
    >,
    /// Storage for NUXs the user has encountered.
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
...
pub struct KnownFollowersBuilder<'a, S: known_followers_state::State> {
    ...
    __unsafe_private_named: (
        ...
        ::core::option::Option<
            Vec<crate::generated::app_bsky::actor::ProfileViewBasic<'a>>,
        >,
    ),
    _phantom: ::core::marker::PhantomData<&'a ()>,
}
...
pub struct LabelersPrefBuilder<'a, S: labelers_pref_state::State> {
    ...
    __unsafe_private_named: (
        ::core::option::Option<
            Vec<crate::generated::app_bsky::actor::LabelerPrefItem<'a>>,
        >,
    ),
    _phantom: ::core::marker::PhantomData<&'a ()>,
}
...
pub struct MutedWordBuilder<'a, S: muted_word_state::State> {
    ...
    __unsafe_private_named: (
        ...
        ::core::option::Option<jacquard_common::CowStr<'a>>,
        ::core::option::Option<
            Vec<crate::generated::app_bsky::actor::MutedWordTarget<'a>>,
        >,
        ::core::option::Option<jacquard_common::CowStr<'a>>,
    ),
    _phantom: ::core::marker::PhantomData<&'a ()>,
...
pub struct PostInteractionSettingsPref<'a> {
    ...
    pub postgate_embedding_rules: std::option::Option<
        Vec<crate::generated::app_bsky::feed::postgate::DisableRule<'a>>,
    >,
    /// Matches threadgate record. List of rules defining who can reply to this users posts. If value is an empty array, no one can reply. If value is undefined, anyone can reply.
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
...
pub enum PostInteractionSettingsPrefThreadgateAllowRulesItem<'a> {
    ...
    ThreadgateMentionRule(
        Box<crate::generated::app_bsky::feed::threadgate::MentionRule<'a>>,
    ),
    #[serde(rename = "app.bsky.feed.threadgate#followerRule")]
    ThreadgateFollowerRule(
        Box<crate::generated::app_bsky::feed::threadgate::FollowerRule<'a>>,
    ),
    #[serde(rename = "app.bsky.feed.threadgate#followingRule")]
    ThreadgateFollowingRule(
        Box<crate::generated::app_bsky::feed::threadgate::FollowingRule<'a>>,
    ),
...
pub enum PreferencesItem<'a> {
    ...
    LiveEventPreferences(
        Box<crate::generated::app_bsky::actor::LiveEventPreferences<'a>>,
    ),
}
...
pub struct ProfileAssociated<'a> {
    ...
    pub chat: std::option::Option<
        crate::generated::app_bsky::actor::ProfileAssociatedChat<'a>,
    >,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    pub feedgens: std::option::Option<i64>,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub germ: std::option::Option<
        crate::generated::app_bsky::actor::ProfileAssociatedGerm<'a>,
    >,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
...
pub struct ProfileView<'a> {
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub associated: std::option::Option<
        crate::generated::app_bsky::actor::ProfileAssociated<'a>,
    >,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    ...
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub verification: std::option::Option<
        crate::generated::app_bsky::actor::VerificationState<'a>,
    >,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
...
impl<'a, S: profile_view_state::State> ProfileViewBuilder<'a, S> {
    ...
    pub fn associated(
        mut self,
        value: impl Into<
            Option<crate::generated::app_bsky::actor::ProfileAssociated<'a>>,
        >,
    ) -> Self {
        self.__unsafe_private_named.0 = value.into();
        self
...
impl<'a, S: profile_view_state::State> ProfileViewBuilder<'a, S> {
    ...
    pub fn verification(
        mut self,
        value: impl Into<
            Option<crate::generated::app_bsky::actor::VerificationState<'a>>,
        >,
    ) -> Self {
...
pub struct ProfileViewDetailed<'a> {
    ...
    pub joined_via_starter_pack: std::option::Option<
        crate::generated::app_bsky::graph::StarterPackViewBasic<'a>,
    >,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub labels: std::option::Option<
...
impl<'a, S: profile_view_detailed_state::State> ProfileViewDetailedBuilder<'a, S> {
    ...
    pub fn joined_via_starter_pack(
        mut self,
        value: impl Into<
            Option<crate::generated::app_bsky::graph::StarterPackViewBasic<'a>>,
        >,
    ) -> Self {
        self.__unsafe_private_named.12 = value.into();
        self
...
pub struct StatusView<'a> {
    ...
    pub embed: std::option::Option<
        crate::generated::app_bsky::embed::external::View<'a>,
    >,
    /// The date when this status will expire. The application might choose to no longer return the status after expiration.
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    pub expires_at: std::option::Option<jacquard_common::types::string::Datetime>,
...
pub struct VerificationStateBuilder<'a, S: verification_state_state::State> {
    ...
    __unsafe_private_named: (
        ::core::option::Option<jacquard_common::CowStr<'a>>,
        ::core::option::Option<
            Vec<crate::generated::app_bsky::actor::VerificationView<'a>>,
        >,
        ::core::option::Option<jacquard_common::CowStr<'a>>,
    ),
    _phantom: ::core::marker::PhantomData<&'a ()>,
...
pub struct ViewerState<'a> {
    ...
    #[serde(borrow)]
    pub activity_subscription: std::option::Option<
        crate::generated::app_bsky::notification::ActivitySubscription<'a>,
    >,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    ...
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub blocking_by_list: std::option::Option<
        crate::generated::app_bsky::graph::ListViewBasic<'a>,
    >,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    ...
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub known_followers: std::option::Option<
        crate::generated::app_bsky::actor::KnownFollowers<'a>,
    >,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    pub muted: std::option::Option<bool>,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub muted_by_list: std::option::Option<
        crate::generated::app_bsky::graph::ListViewBasic<'a>,
    >,
}
