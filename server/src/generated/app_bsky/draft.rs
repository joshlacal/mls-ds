...
impl<'a, S: draft_state::State> DraftBuilder<'a, S> {
    ...
    pub fn postgate_embedding_rules(
        mut self,
        value: impl Into<
            Option<Vec<crate::generated::app_bsky::feed::postgate::DisableRule<'a>>>,
        >,
    ) -> Self {
...
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        ...
        defs: {
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("draft"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    ...
                    required: Some(
                        vec![::jacquard_common::smol_str::SmolStr::new_static("posts")],
                    ),
                    nullable: None,
                    properties: {
                        #[allow(unused_mut)]
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("draftEmbedCaption"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: None,
                    required: Some(
                        vec![
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("draftEmbedExternal"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: None,
                    required: Some(
            ...
            map.insert(
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    ...
                    required: Some(
                        vec![
                            ::jacquard_common::smol_str::SmolStr::new_static("localRef")
                        ],
                    ),
                    nullable: None,
                    properties: {
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("draftEmbedLocalRef"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: None,
                    required: Some(
                        vec![::jacquard_common::smol_str::SmolStr::new_static("path")],
                    ),
                    nullable: None,
                    properties: {
                        #[allow(unused_mut)]
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("draftEmbedRecord"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: None,
                    required: Some(
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("draftEmbedVideo"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: None,
                    required: Some(
                        vec![
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("draftPost"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: Some(
                        ::jacquard_common::CowStr::new_static(
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("draftWithId"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: Some(
                        ::jacquard_common::CowStr::new_static(
...
pub struct DraftEmbedVideo<'a> {
    ...
    pub captions: std::option::Option<
        Vec<crate::generated::app_bsky::draft::DraftEmbedCaption<'a>>,
    >,
    #[serde(borrow)]
    pub local_ref: crate::generated::app_bsky::draft::DraftEmbedLocalRef<'a>,
}
...
impl<'a, S: draft_embed_video_state::State> DraftEmbedVideoBuilder<'a, S> {
    ...
    pub fn captions(
        mut self,
        value: impl Into<
            Option<Vec<crate::generated::app_bsky::draft::DraftEmbedCaption<'a>>>,
        >,
    ) -> Self {
        self.__unsafe_private_named.1 = value.into();
        self
...
pub struct DraftPost<'a> {
    ...
    pub embed_externals: std::option::Option<
        Vec<crate::generated::app_bsky::draft::DraftEmbedExternal<'a>>,
    >,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub embed_images: std::option::Option<
        Vec<crate::generated::app_bsky::draft::DraftEmbedImage<'a>>,
    >,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub embed_records: std::option::Option<
        Vec<crate::generated::app_bsky::draft::DraftEmbedRecord<'a>>,
    >,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub embed_videos: std::option::Option<
        Vec<crate::generated::app_bsky::draft::DraftEmbedVideo<'a>>,
    >,
    /// Self-label values for this post. Effectively content warnings.
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
