...
pub struct GetActorStarterPacksBuilder<'a, S: get_actor_starter_packs_state::State> {
...
impl<'a> GetActorStarterPacksBuilder<'a, get_actor_starter_packs_state::Empty> {
...
impl<'a, S> GetActorStarterPacksBuilder<'a, S>
where
    S: get_actor_starter_packs_state::State,
    S::Actor: get_actor_starter_packs_state::IsUnset,
{
    /// Set the `actor` field (required)
    pub fn actor(
        mut self,
        value: impl Into<jacquard_common::types::ident::AtIdentifier<'a>>,
    ) -> GetActorStarterPacksBuilder<'a, get_actor_starter_packs_state::SetActor<S>> {
...
where
    S: get_actor_starter_packs_state::State,
    S::Actor: get_actor_starter_packs_state::IsSet,
{
    /// Build the final struct
    pub fn build(self) -> GetActorStarterPacks<'a> {
