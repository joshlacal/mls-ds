-- =============================================================================
-- Complete MLS Server Schema
-- Created: 2025-11-02
-- Description: Complete schema for fresh deployments including all tables
-- =============================================================================

-- Drop existing tables if starting fresh (CAUTION: This deletes all data!)
-- Uncomment the following block only when doing a fresh install
/*
...
DROP FUNCTION IF EXISTS set_default_key_package_expiry() CASCADE;
*/
...
CREATE INDEX IF NOT EXISTS idx_conversations_idempotency ON conversations(idempotency_key) WHERE idempotency_key IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_key_packages_did ON key_packages(did);
...
-- Function to set default expiry for key packages
...
-- =============================================================================
-- Blob Storage (for future R2 migration)
-- =============================================================================
...
CREATE INDEX IF NOT EXISTS idx_idempotency_endpoint ON idempotency_cache(endpoint);
