...
1. **APNs Integration** 
   ...
   - Key location: `/home/ubuntu/.config/bluesky-push-notifier/keys/AuthKey_YOUR_KEY_ID.p8`
...
APNS_KEY_PATH=/home/ubuntu/.config/bluesky-push-notifier/keys/AuthKey_YOUR_KEY_ID.p8
...
4. **Add to Doppler (Optional)**
   ...
   doppler secrets set APNS_KEY_PATH=/home/ubuntu/.config/bluesky-push-notifier/keys/AuthKey_YOUR_KEY_ID.p8
   doppler secrets set APNS_KEY_ID=YOUR_KEY_ID
...
1. **Verify APNs Key**:
   ...
   # Should show AuthKey_YOUR_KEY_ID.p8
   ```
